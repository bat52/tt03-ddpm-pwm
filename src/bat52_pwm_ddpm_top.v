...
always @(inval, pwm_ddpm0_count) begin: BAT52_PWM_DDPM_TOP_PWM_DDPM0_PWM_PROC
...
always @(inval, pwm_ddpm0_count) begin: BAT52_PWM_DDPM_TOP_PWM_DDPM0_DDPM_INT_PROC
    integer bidx;
